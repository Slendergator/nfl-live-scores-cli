...
I don't fucking care lol# nfl-live-scores-cli

Live NFL scores in your terminal, powered by ESPN's public API. Auto-refreshes every 30 seconds with a countdown timer, showing only in-progress games.
...
The table will refresh every 30 seconds with a live countdown. Press `Ctrl+C` to exit.
